...
if __name__ == '__main__':
    ...
    btnInsert  = tk.Button(m, text = 'Insert', width=20, command=btnInsertClicked,  bg='orange').grid(row=5, column=1)
    btnUpdate  = tk.Button(m, text='Update', width=20, command=btnUpdateClicked, bg='blue').grid(row=6, column=1)
    btnDelete  = tk.Button(m, text='Delete', width=20, command=btnDeleteClicked, bg='red').grid(row=7, column=1)
    btnReadOne = tk.Button(m, text='ReadOne', width=20, command=btnReadOneClicked, bg='gray').grid(row=8, column=1)
    btnReadAll = tk.Button(m, text='ReadAll', width=20, command=btnReadAllClicked, bg='aqua').grid(row=9, column=1)
